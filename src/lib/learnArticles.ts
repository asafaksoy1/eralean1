...
export const learnArticles: LearnArticle[] = [
  ...
  },
  {
    ...
    description: "A step-by-step UK guide to building a Klaviyo sunset flow to re-engage or suppress inactive subscribers, protect sender reputation and cut billing.",
    category: "Klaviyo",
  },
];
